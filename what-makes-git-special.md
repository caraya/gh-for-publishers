...
> You will never loose all your data. If the server hosting the repository crashes you still have your local copy which you can rebuild the repository from.  If your local copy is destroyed or you delete a file by mistake (like the author has on exusted code binges at 3am.) you will only loose the changes that haven't been posted to the repository.
